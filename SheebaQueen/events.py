...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import SheebaQueen.events

        path = Path(f"SheebaQueen/modules/{shortname}.py")
        name = "SheebaQueen.modules.{}".format(shortname)
        ...
        mod.SheebaQueen = SheebaQueen
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["SheebaQueen.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "SheebaQueen/modules/*.py"
