...
import SheebaQueen.modules.sql.notes_sql as sql
from SheebaQueen import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from SheebaQueen.__main__ import DATA_IMPORT
from SheebaQueen.modules.helper_funcs.chat_status import user_admin
from SheebaQueen.modules.helper_funcs.alternate import typing_action

# from SheebaQueen.modules.rules import get_rules
import SheebaQueen.modules.sql.rules_sql as rulessql

# from SheebaQueen.modules.sql import warns_sql as warnssql
import SheebaQueen.modules.sql.blacklist_sql as blacklistsql
from SheebaQueen.modules.sql import disable_sql as disabledsql

# from SheebaQueen.modules.sql import cust_filters_sql as filtersql
# import SheebaQueen.modules.sql.welcome_sql as welcsql
import SheebaQueen.modules.sql.locks_sql as locksql
from SheebaQueen.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("SheebaQueen{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SheebaQueen{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SheebaQueen-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SheebaQueen{}.backup".format(chat_id))  # Cleaning file
