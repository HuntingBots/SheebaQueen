...
import SheebaQueen.modules.sql.global_bans_sql as gban_sql
import SheebaQueen.modules.sql.users_sql as user_sql
from SheebaQueen import DEV_USERS, OWNER_ID, dispatcher
