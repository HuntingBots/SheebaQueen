...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "SheebaQueen/elevated_users.json")
...
# *Global Blue Text*
#  ❍ /gignoreblue*:* <word>*:* Globally ignorea bluetext cleaning of saved word across SheebaQueen.
